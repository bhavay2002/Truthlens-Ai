...
## src/data_processing/ Audit v3 (13-issue fix pass, April 2026)
Third-pass audit targeting the data layer. All fixes verified by behavioural smoke test (`CACHE_VERSION` bumped `v3 → v4` to invalidate stale entries built before the fingerprint fix).
