...
class NarrativeConflictAnalyzer:
    ...
    def analyze(self, text: str) -> Dict[str, float]:
        ...
        features.update(self._punctuation_conflict(text))
    ...
    def _entity_opposition(self, doc) -> Dict[str, float]:
        ...
        repeated_entities = sum(1 for _, count in entity_counts.items() if count > 1)
    ...
    def _punctuation_conflict(self, text: str) -> Dict[str, float]:
        ...
        return {
            ...
            "narrative_conflict_question_ratio": float(question_marks / length),
        }
...
def narrative_conflict_vector(features: Dict[str, float]) -> np.ndarray:
    ...
    try:
        ...
        raise RuntimeError("Failed to convert narrative conflict features") from exc